        ...
        <div class="row pb-3 mx-auto">
	        <div class="col-md-7 offset-2">
	        	<h3 class="mb-5 text-gray-800 text-center">Form Pendaftaran Pasien</h3>

	        	<form action="" method="post">
        			<div class="form-group row">
					    <div class="col-md-6">
					    	<label for="nomor_pendaftaran"><strong>Nomor Pendaftaran</strong></label>
						    <input type="text" class="form-control" id="nomor_pendaftaran" name="nomor_pendaftaran" value="<?= set_value('nomor_pendaftaran'); ?>" autocomplete="off">
	        		...
	        		<div class="form-group row">
					    <div class="col-md-6">
						    ...
						    <input type="text" class="form-control" id="biaya" name="biaya" value="<?= set_value('biaya'); ?>" autocomplete="off">
					...
					<div class="form-group">
					    ...
					    value="<?= set_value('tanggal_berobat'); ?>" autocomplete="off"> 

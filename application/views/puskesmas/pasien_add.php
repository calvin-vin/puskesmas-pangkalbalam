	        	...
	        	<form action="<?= base_url('puskesmas/pasien_add') ?>" method="post">
        			<div class="form-group row">
					    <div class="col-md-6">
						    ...
						    value="<?= set_value('nomor_pasien'); ?>" autocomplete="off">
	        		...
	        		<div class="form-group row">
		          	...
		          	<div class="form-group">
					    ...
					    value="<?= set_value('nama'); ?>" autocomplete="off">
					...
					<div class="form-group">
					    ...
					    value="<?= set_value('tanggal_lahir'); ?>" autocomplete="off"> 
					...
					<div class="form-group">
					    ...
					    <textarea class="form-control" id="alamat" rows="3" name="alamat" autocomplete="off"><?= set_value('alamat'); ?></textarea>

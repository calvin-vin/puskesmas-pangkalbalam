        ...
        <div class="row pb-3 mx-auto">
          <div class="col-md-7 offset-2">
            <h3 class="mb-5 text-gray-800 text-center">Form Ubah Obat</h3>
            ...
            <form action="" method="post">
              ...
              <div class="col-md-6">
                ...
                value="<?= $obat['nomor_obat']; ?>" autocomplete="off">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="nama" name="nama" value="<?= $obat['nama']; ?>" autocomplete="off">
              ...
              value="<?= $obat['jenis']; ?>" autocomplete="off">
          ...
          <div class="form-group">
              ...
              value="<?= $obat['tanggal_masuk']; ?>" autocomplete="off"> 
              <?= form_error('tanggal_masuk', '<small class="text-danger pl-1">','</small>'); ?>
          </div>
          <div class="form-group row mb-4">
              <div class="col-md-6">
                <label for="stok"><strong>Stok Obat</strong></label>
                <input type="text" class="form-control" id="spinner" name="stok" value="<?= $obat['stok']; ?>" autocomplete="off" min="0">
              </div>
          </div>
          <div class="form-group">

        ...
        <div class="row pb-3 mx-auto">
	        <div class="col-md-7 offset-2">
	        	<h3 class="mb-5 text-gray-800 text-center">Form Tambah Penyakit</h3>

	        	<form action="<?= base_url('puskesmas/penyakit_add') ?>" method="post">
        			<div class="form-group row">
					    <div class="col-md-6">
						    ...
						    value="<?= set_value('nomor_penyakit'); ?>" autocomplete="off">
